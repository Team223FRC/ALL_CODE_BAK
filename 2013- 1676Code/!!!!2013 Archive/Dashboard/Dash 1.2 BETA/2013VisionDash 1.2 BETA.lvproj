...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Max Vision" Type="Folder">
			<Item Name="Create HSL Mask.vi" Type="VI" URL="../Max Vision/Create HSL Mask.vi"/>
			<Item Name="Crop Image.vi" Type="VI" URL="../Max Vision/Crop Image.vi"/>
			<Item Name="Vision Main.vi" Type="VI" URL="../Max Vision/Vision Main.vi"/>
			<Item Name="DrawCrossHairs.vi" Type="VI" URL="../Max Vision/DrawCrossHairs.vi"/>
			<Item Name="Filter And Analyze.vi" Type="VI" URL="../Max Vision/Filter And Analyze.vi"/>
			<Item Name="Calculate Distance.vi" Type="VI" URL="../Max Vision/Calculate Distance.vi"/>
			<Item Name="Calculate Target Data.vi" Type="VI" URL="../Max Vision/Calculate Target Data.vi"/>
			<Item Name="Sort Targets.vi" Type="VI" URL="../Max Vision/Sort Targets.vi"/>
			<Item Name="Anotate Image.vi" Type="VI" URL="../Max Vision/Anotate Image.vi"/>
		</Item>
