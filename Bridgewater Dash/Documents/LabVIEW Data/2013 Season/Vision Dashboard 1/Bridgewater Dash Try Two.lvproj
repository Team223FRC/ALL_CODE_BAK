...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Vision" Type="Folder">
			<Item Name="Frisbee" Type="Folder">
				<Item Name="Linear Regression Code" Type="Folder">
					<Item Name="Intercept.vi" Type="VI" URL="../Intercept.vi"/>
					<Item Name="Slope.vi" Type="VI" URL="../Slope.vi"/>
					<Item Name="Linear Regression Code.vi" Type="VI" URL="../Linear Regression Code.vi"/>
					<Item Name="xy to x y.vi" Type="VI" URL="../xy to x y.vi"/>
				</Item>
				<Item Name="Sorting and Processing" Type="Folder">
					<Item Name="Frisbee Vision Cluster Sorter.vi" Type="VI" URL="../Frisbee Vision Cluster Sorter.vi"/>
					<Item Name="Circle Info.vi" Type="VI" URL="../Circle Info.vi"/>
				</Item>
				<Item Name="Frisbee Vision Processing.vi" Type="VI" URL="../Frisbee Vision Processing.vi"/>
				<Item Name="Frisbee Code.vi" Type="VI" URL="../../../../../Desktop/Vision Stuff/Frisbee Code.vi"/>
			</Item>
			<Item Name="Target" Type="Folder">
				<Item Name="Target Vision Processing.vi" Type="VI" URL="../Target Vision Processing.vi"/>
				<Item Name="Distance From Pixels.vi" Type="VI" URL="../Distance From Pixels.vi"/>
				<Item Name="Rambo Code 2.vi" Type="VI" URL="../Rambo Code 2.vi"/>
			</Item>
		</Item>
		<Item Name="Dashboard Main.vi" Type="VI" URL="../Dashboard Main.vi"/>
		<Item Name="Control 2.ctl" Type="VI" URL="../../../../../Control 2.ctl"/>
		<Item Name="Code stuff and things.vi" Type="VI" URL="../../../../../Code stuff and things.vi"/>
		<Item Name="Comparison.vi" Type="VI" URL="../../../../../Comparison.vi"/>
		<Item Name="Blackout.vi" Type="VI" URL="../../../../../../223 Custom Toolkit/Vision/Blackout.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Two line search.vi" Type="VI" URL="../../../../../Two line search.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC PC Dashboard" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{E9E3A292-66ED-4A5A-859C-E9320C3FBD3C}</Property>
